...
//            System.out.printf("Indexing \"%s\"\n", arg);
            ...
            doc.add(new StringField("Id", content_I, Field.Store.YES));
            doc.add(new TextField("Title", content_T, Field.Store.YES));
            doc.add(new TextField("Aut", content_A, Field.Store.YES));
            doc.add(new TextField("Bibi", content_B, Field.Store.YES));
            doc.add(new TextField("Word", content_W, Field.Store.YES));
